...
API_ID = int(environ.get('API_ID', '25324405'))
API_HASH = environ.get('API_HASH', '1218ca10c2f703c606ea779512bc6b1a')
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1460165398').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001811601007').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://amankr1net9:bU6vraaUhjLwRfOY@cluster0.rrm2yj3.mongodb.net/?retryWrites=true&w=majority")
...
SHORTLINK_API = environ.get('SHORTLINK_API', '5ce7abb9a4dde8e04fa9f636e834d9446e3a86e7')
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001921470476'))
